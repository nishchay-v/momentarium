            ...
            >
                ...
                <div
                    ...
                    style={{
                        ...
                        opacity: isHovered ? OVERLAY_HOVER_OPACITY : OVERLAY_DEFAULT_OPACITY,
...
const InfiniteCanvas = ({
    ...
    const { grid, tileWidth, tileHeight } = useMemo(() => {
        ...
        const gridItems: GridItem[] = items.map((child) => {
            ...
            const height = Math.min(Math.max(baseHeight * HEIGHT_SCALE_FACTOR, MIN_ITEM_HEIGHT), MAX_ITEM_HEIGHT);
        ...
        >
          ...
          `,
            ...
            <motion.div
                ...
                transition={{ delay: INSTRUCTION_OVERLAY_DELAY, duration: INSTRUCTION_OVERLAY_DURATION }}
            >
                <div className="flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-xl rounded-full border border-white/10">
                    <div className="flex gap-1">
                        ...
                        <div className="w-1.5 h-1.5 rounded-full bg-white/30 animate-pulse" style={{ animationDelay: `${PULSE_DELAY_1}s` }} />
                        <div className="w-1.5 h-1.5 rounded-full bg-white/20 animate-pulse" style={{ animationDelay: `${PULSE_DELAY_2}s` }} />
                    </div>
